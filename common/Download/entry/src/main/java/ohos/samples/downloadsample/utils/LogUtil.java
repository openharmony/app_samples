...
package ohos.samples.downloadsample.utils;
...
public class LogUtil {
    private static final String TAG_LOG = "DownloadSample";

    private static final HiLogLabel LABEL_LOG = new HiLogLabel(3, 0, LogUtil.TAG_LOG);
